...
(irradiation rate) = 0.25 kW/m^2 until the mlr is within 20% of 
the desired value.
...
# pre-set maximum logging frequency
...
with open(full_name_of_file, "w", newline = "") as handle:
	...
	writer.writerows([['time_seconds', "mass_g", 
		...
		"Observations", "PID_state", "O2_%", "DPT_Pa",
		"CO_ppm", "CO2_ppm", "APT_kPa", "Duct_TC_K",
		"Ambient_TC_K", "RH_%"]])
